...
class ColaboradorForm(forms.ModelForm):
    ...
    class Meta:
        ...
        model = Colaborador
        fields = ["nome", "user", "data_nascimento", "cpf", "cpffile", "errege", "rgfile", "endereco", "cidade", "estado", "pais", "telefone", "banco", "conta", "emailpessoal", "emailshoot", "foto", "funcaodobrother", "salario", "instagram","linkedin","facebook", "entrounashoot", "desligado"]
