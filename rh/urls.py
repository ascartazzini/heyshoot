...
from rh.views import (BibliotecaView, CanaisProprietariosView,
                      ...
                      FinanceiroTotalView, FolguinhaView,
                      FornecedoresDetalhesView, FornecedoresView,
                      HierarquiaView, IndexView, InscricaoView, JuridicoView,
                      LoginShootView, LogoutShootView, MomentoImportanteView,
                      NewsletterView, PalestraView, PremiacaoView,
